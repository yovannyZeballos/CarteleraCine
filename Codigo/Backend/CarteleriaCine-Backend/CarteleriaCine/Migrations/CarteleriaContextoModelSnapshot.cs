...
namespace CarteleriaCine.Migrations
{
    ...
    partial class CarteleriaContextoModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("CarteleriaCine.Model.ReservaPelicula", b =>
                {
                    ...
                    b.Property<int>("HorarioPeliculaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarteleriaCine.Model.ReservaPelicula", b =>
                {
                    ...
                    b.HasOne("CarteleriaCine.Model.HorarioPelicula", "HorarioPelicula")
                        .WithMany()
                        .HasForeignKey("HorarioPeliculaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Cliente");

                    b.Navigation("HorarioPelicula");
                });
